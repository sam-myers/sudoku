...
#[allow(dead_code)]
pub fn board_1() -> Result<Board, InvalidPuzzle> {
    Board::new()
...
#[allow(dead_code)]
pub fn board_2() -> Result<Board, InvalidPuzzle> {
    Board::new()
...
#[allow(dead_code)]
fn invalid_2() -> Result<Board, InvalidPuzzle> {
    Board::new()
        .given(0, 0, num::Num::Three)?
...
#[allow(dead_code)]
fn invalid_3() -> Result<Board, InvalidPuzzle> {
    Board::new()
        .given(0, 0, num::Num::Three)?
...
#[allow(dead_code)]
fn invalid_vertical_1() -> Result<Board, InvalidPuzzle> {
    Board::new()
...
#[allow(dead_code)]
fn invalid_horizontal_1() -> Result<Board, InvalidPuzzle> {
    Board::new()
        .given(0, 0, num::Num::One)?
...
#[allow(dead_code)]
fn invalid_grid_1() -> Result<Board, InvalidPuzzle> {
    Board::new()
        .given(0, 0, num::Num::One)?
//        .given(0, 1, num::Num::Three)?
        .given(0, 2, num::Num::Three)?
...
#[allow(dead_code)]
pub fn invalid_grid_2() -> Result<Board, InvalidPuzzle> {
    Board::new()
